...
-- Dumping data for table world.areatrigger_teleport: 257 rows
...
INSERT INTO `areatrigger_teleport` (`id`, `name`, `target_map`, `target_position_x`, `target_position_y`, `target_position_z`, `target_orientation`) VALUES
	...
	(78, 'DeadMines Entrance', 36, -15.1488, -376.899, 60.5414, 3.06951),
	(101, 'Stormwind Stockades Entrance', 34, 54.23, 0.28, -18.34, 6.26),
	(107, 'Stormwind Vault Entrance', 35, -0.91, 40.57, -24.23, 0.01),
	(109, 'Stormwind Vault Instance', 0, -8653.45, 606.19, 91.16, 0.01),
	(119, 'DeadMines Instance Start', 0, -11208.5, 1672.07, 24.6695, 4.70845),
	(121, 'Deadmines Instance End', 0, -11339.4, 1571.16, 100.56, 0.01),
	(145, 'Shadowfang Keep Entrance', 33, -228.271, 2111.35, 76.8898, 1.19239),
	(194, 'Shadowfang keep - Exit', 0, -235.112, 1561.79, 76.8847, 4.33124),
	(226, 'The Barrens - Wailing Caverns', 1, -740.059, -2214.23, 16.1374, 5.68),
	(228, 'The Barrens - Wailing Caverns', 43, -163.49, 132.9, -73.66, 5.83),
	(242, 'Razorfen Kraul Instance Start', 1, -4464.92, -1666.24, 90, 0.01),
	(244, 'Razorfen Kraul Entrance', 47, 1943, 1544.63, 82, 1.38),
	(257, 'Blackphantom Deeps Entrance', 48, -151.89, 106.96, -39.87, 4.53),
	(259, 'Blackphantom Deeps Instance Start', 1, 4247.74, 745.879, -24.5299, 0.01),
	(286, 'Uldaman Entrance', 70, -226.8, 49.09, -46.03, 1.39),
	(288, 'Uldaman Instance Start', 0, -6066.73, -2955.63, 209.776, 0.01),
	...
	(444, 'Razorfen Downs Instance Start', 1, -4658.12, -2526.35, 82.9671, 0.01),
	(446, 'Altar of Atal\'Hakkar Entrance', 109, -319.24, 99.9, -131.85, 3.19),
	(448, 'Altar Of Atal\'Hakkar Instance Start', 0, -10175.1, -3995.15, -112.9, 0.01),
	(503, 'Stockades Instance', 0, -8764.83, 846.075, 87.4842, 0.01),
	...
	(882, 'Uldaman Instance End', 0, -6620.48, -3765.19, 266.91, 0.01),
	(902, 'Uldaman Exit', 70, -214.02, 383.607, -38.7687, 0.5),
	(922, 'Zul\'Farrak Instance Start', 1, -6796.49, -2890.77, 8.88063, 0.01),
	...
	(1470, 'Blackrock Spire - Searing Gorge Instance', 0, -7524.19, -1230.13, 285.743, 0.01),
	(1472, 'Blackrock Dephts - Searing Gorge Instance', 0, -7179.63, -923.667, 166.416, 0.01),
	...
	(2221, 'Stratholme - Eastern Plaguelands Instance (Inside)', 0, 3235.46, -4050.6, 110.01, 0.01),
	...
	(2568, 'Scholomance Instance', 0, 1275.05, -2552.03, 90.3994, 0.01),
	...
	(3126, 'Maraudon', 1, -1186.98, 2875.95, 85.7258, 0.01),
	(3131, 'Maraudon', 1, -1471.07, 2618.57, 76.1944, 0.01),
	(3133, 'Maraudon', 349, 1019.69, -458.31, -43.43, 0.31),
	(3134, 'Maraudon', 349, 752.91, -616.53, -33.11, 1.37),
	(3183, 'Dire Maul', 429, 44.4499, -154.822, -2.71201, 0.01),
	(3184, 'Dire Maul', 429, -201.11, -328.66, -2.72, 5.22),
	(3185, 'Dire Maul', 429, 9.31119, -837.085, -32.5305, 0.01),
	(3186, 'Dire Maul', 429, -62.9658, 159.867, -3.46206, 0.01),
	(3187, 'Dire Maul', 429, 31.5609, 159.45, -3.4777, 0.01),
	(3189, 'Dire Maul', 429, 255.249, -16.0561, -2.58737, 4.7),
	(3190, 'Dire Maul', 1, -3831.79, 1250.23, 160.223, 0.01),
	...
	(3195, 'Dire Maul', 1, -3980.58, 776.193, 161.006, 0.01),
	(3196, 'Dire Maul', 1, -4030.21, 127.966, 26.8109, 0.01),
	(3197, 'Dire Maul', 1, -3577.67, 841.859, 134.594, 0.01),
	...
	(3930, 'Zul\'Gurub Exit ', 0, -11916.3, -1208.37, 92.2868, 0.01),
	(3948, 'Arathi Basin Alliance Out', 0, -1198, -2533, 22, 0.01),
	(3949, 'Arathi Basin Horde Out', 0, -817, -3509, 73, 0.01),
	(4006, 'Ruins Of Ahn\'Qiraj (Inside)', 1, -8418.5, 1505.94, 31.8232, 0.01),
	(4008, 'Ruins Of Ahn\'Qiraj (Outside)', 509, -8429.74, 1512.14, 31.9074, 0.01),
	(4010, 'Ahn\'Qiraj Temple (Outside)', 531, -8231.33, 2010.6, 129.861, 0.01),
	(4012, 'Ahn\'Qiraj Temple (Inside)', 1, -8242.67, 1992.06, 129.072, 0.01),
	...
	(4354, 'Dark Portal To Outland', 530, -248, 956, 84.3268, 1.59436),
	(4363, 'The Underbog (Entrance)', 546, 9.71391, -16.2008, -2.75334, 5.57082),
	(4364, 'The Steamvault (Entrance)', 545, -13.8425, 6.7542, -4.2586, 0.01),
	...
	(4386, 'Sunstrider Isle to Eastern Plaguelands', 0, 3476.36, -4493.36, 137.49, 0.01),
	...
	(4520, 'Karazhan, Service (Exit)', 0, -11034.8, -2003.8, 92.98, 0.01),
	...
	(5258, 'Vault of Archavon (Entrance)', 624, -505.96, -103.353, 157, 0.01),
	...
	(5510, 'Trial of the Champion (Exit)', 571, 8577.4, 791.732, 558.235, 0.01),
	...
	(5879, 'Hyajl Firelands Forgeworks tele up', 1, 5043.43, -2039.24, 1368.61, 4.82),
	(5880, 'Hyjal Lightning Edge tele down', 1, 5028.14, -2030.77, 1148.97, 4.5),
	(6011, 'Blackrock carvens (Exit)', 0, -7571.42, -1320.84, 245.538, 1.638),
	(6108, 'Blackrock carvens (Enterance)', 645, 211.15, 1131.12, 205.8, 4.6767),
	(6177, 'Grim Batol (Exit)', 0, -4061.7, -3450.36, 280.649, 3.44912),
	(6179, 'Grim Batol (Enterance)', 670, -623.233, -194, 272.022, 4.99948),
	(6194, 'Stonecore (Exit)', 646, 1027.44, 628.709, 157.141, 1.82351),
	(6196, 'Stonecore (Enterance)', 725, 839.192, 986.05, 317.421, 0.006879),
	(6197, 'Throne of the Tides(Exit)', 0, -5599.09, 5412.06, -1798.73, 2.40455),
	(6200, 'Throne of the Tides (Entrance)', 0, -5648.53, 5465.77, -1541.27, 5.437),
	...
	(6354, 'Bastion of Twilight (Enterance)', 671, -566.793, -531.946, 890.593, 0.001263),
	...
	(6580, 'Blackwing Descent (Exit)', 0, -7538.49, -1198.22, 477.721, 5.0859),
	(6581, 'Blackwing Descent (Enterance)', 669, -349.316, -225.234, 192.842, 0.00123),
	(6610, 'The Vortex Pinnacle (Exit)', 1, -11512.3, -2309.14, 608.394, 0.681683),
	...
	(6620, 'Lost City of the Tol\'vir (Enterance)', 755, -10701.4, -1312.92, 17.6047, 3.41487),
	(6664, 'Baradin Hold (Enterance)', 757, 165.2, 1337.02, 170.765, 0.034195),
	(6672, 'Throne of The Four Winds (Enterance)', 754, -292.981, 820.474, 184.928, 0.166035),
	(6673, 'Throne of The Four Winds (Exit)', 1, -11355, 58.1568, 723.883, 5.01194),
	(6769, 'Zul\'Gurub Exit ', 0, -11916.3, -1208.37, 92.2868, 0),
	(6775, 'Zul\'Gurub Entrance', 859, -11916.4, -1287.09, 85.143, 4.848),
	(6864, 'Firelands Entrance', 720, -541.493, 317.149, 115.495, 5.894),
	(6866, 'Firelands Exit', 1, 3993.39, -2954.48, 1002.55, 5.136),
	(7151, 'End Time entrance', 938, 3727.48, -408.095, 110.561, 2.17),
	(7154, 'Hour of Twilight entrance', 940, 4927.23, 297.033, 97.175, 4.631),
	(7155, 'Dragon Soul entrance', 967, -2248.26, -2401.06, 86.7, 0.007),
	(7162, 'End Time exit', 1, -8599.66, -4031.26, -208.326, 4.74),
	(7163, 'Hour of Twilight exit', 1, -8289.77, -4566.6, -223.84, 1.62),
	(7164, 'Dragon Soul exit', 1, -8304.6, -4525.54, -217.182, 2.23);
